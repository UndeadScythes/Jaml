...
public class ConfigurationSerialization {
    ...
    private static Map<String, Class<? extends ConfigurationSerializable>> aliases = new HashMap<String, Class<? extends ConfigurationSerializable>>(0);
    ...
    public ConfigurationSerializable deserialize(Map<String, ?> args) {
        if(args == null) throw new NullPointerException("Arguments cannot be null.");
